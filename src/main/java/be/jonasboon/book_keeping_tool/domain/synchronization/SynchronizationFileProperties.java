...
public class SynchronizationFileProperties {
    ...
    public SynchronizationFileProperties(TransactionRepository transactionRepository, CostCenterRepository costCenterRepository, BalanceRepository balanceRepository, BalanceSubPostRepository balanceSubPostRepository) {
    ...
    public void load() {
        PROPERTIES = List.of(
                ...
                new SynchronizationFileProperty<>("transactions.bkt", transactionRepository, ParameterizedTypeReference.forType(Transaction.class))
        );
    }
